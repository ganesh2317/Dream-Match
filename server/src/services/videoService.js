    ...
    async compileVideo(dreamId) {
        try {
            ...
            await new Promise((resolve, reject) => {
                ...
                const ffmpegCmd = `"${ffmpegStatic}" -y -loop 1 -t 5 -i "${inputImagePath}" -filter_complex "${filterComplex}" -c:v libx264 -b:v 1500k -crf 28 -preset ultrafast -pix_fmt yuv420p -movflags +faststart "${outputVideoPath}"`;
